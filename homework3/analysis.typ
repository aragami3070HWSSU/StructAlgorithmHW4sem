...
=== Лучший случай
Дерево идеально сбалансировано. Высота одного поддерева отличается от высоты другого не более чем на 1. Высота такого дерева равна $log n$
=== Средний случай
Любое дерево, не являющееся вырожденным и идеально сбалансированным. Высота(h): $log n lt h lt n$
